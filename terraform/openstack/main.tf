provider "openstack" {
  user_name      = "${var.user_infra}"
  password       = "${var.pass_infra}"
  tenant_id      = "${var.tenant_id_infra}"
  user_domain_id = "${var.domain_id_infra}"
  auth_url       = "${var.url_infra}"
}
